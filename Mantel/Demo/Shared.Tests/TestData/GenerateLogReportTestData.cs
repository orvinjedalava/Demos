...
namespace LogsAPI.Tests.TestData
{
    internal class GenerateLogReportTestData : IEnumerable<object[]>
    {
        ...
        private IEnumerable<object[]> _data = new List<object[]>()
        {
            ...
            {
                new StringBuilder()
                    .AppendLine("177.71.128.21 - - [10/Jul/2018:00:12:00 +1000] \"PUT /external-analytics/ HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (X11; U; Linux x86_64; fr-FR) AppleWebKit/534.7 (KHTML, like Gecko) Epiphany/2.30.6 Safari/534.7\"")
                    ...
                    .AppendLine("50.112.00.11 - admin [10/Jul/2018:00:02:00 +1000] \"GET /asset.css HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6\"")
                    ...
                    .AppendLine("50.112.00.11 - admin [10/Jul/2018:00:05:00 +1000] \"GET /asset.css HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6\"")
                    ...
                    .AppendLine("177.71.128.21 - admin [10/Jul/2018:00:13:00 +1000] \"GET /intranet-analytics/ HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (X11; U; Linux x86_64; fr-FR) AppleWebKit/534.7 (KHTML, like Gecko) Epiphany/2.30.6 Safari/534.7\"")
                    .AppendLine("50.112.00.11 - admin [10/Jul/2018:00:11:00 +1000] \"PUT /asset.css HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6\"")
                    .AppendLine("50.112.00.11 - admin [10/Jul/2018:00:11:00 +1000] \"DELETE /asset.css HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6\"")
                    .AppendLine("50.112.00.11 - admin [10/Jul/2018:00:11:00 +1000] \"GET /asset.css HTTP/1.1\" 200 3574 \"-\" \"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6\"")
                    .ToString(),
                LogType.HttpRequest,
                3,
                new List<RankedItem>() 
                ...
                new List<RankedItem>()
                {
                    new RankedItem(rank: 1, value: "177.71.128.21", 12),
                    new RankedItem(rank: 2, value: "50.112.0.11", 6),
